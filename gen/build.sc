...
// mill _.publishLocal
// mill _.test.test
object contract extends SbtModule with ScalafmtModule with PublishModule {
  def scalaVersion = "3.4.1"

  def pomSettings = PomSettings(
    description = "contract",
    organization = "com.github.aaronp",
    url = "https://github.com/<username>/contract",
    licenses = Seq(License.MIT),
    versionControl = VersionControl.github("<username>", "contract"),
    developers = Seq(
